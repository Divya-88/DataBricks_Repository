...
@dp.materialized_view(
    name="prodcatalog_wd36.logistics_wd36.silver_staff_dlt2",
    comment="Standardized staff data"
)
def silver_staff_dlt1():
    return (
        spark.read.table("prodcatalog_wd36.logistics_wd36.bronze_staff_data1")
        .select(
...
@dp.materialized_view(
    name="prodcatalog_wd36.logistics_wd36.silver_geotag_dlt2",
    comment="Cleaned geotag data",
    table_properties={"quality": "silver"}
)
def silver_geotag_dlt2():
    return (
        spark.read.table("prodcatalog_wd36.logistics_wd36.bronze_geotag_data1")
        .select(
...
@dp.materialized_view(
    name="prodcatalog_wd36.logistics_wd36.silver_shipments_dlt2",
...
def silver_shipments_dlt2():
    ...
    return (
        spark.read.table("prodcatalog_wd36.logistics_wd36.bronze_shipments_data1")
